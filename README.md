...
界面以干净、安静的日式木屋为视觉基调。顶栏、图片和体验卡在首屏内完整呈现；主体图片保持原始比例且不裁切，左右余量由当前画面的柔化延展背景承接，不使用纯色填充。底部卡片不会覆盖图片内容，菜名仍保留在图片内。动效追求克制和连贯，让文字与食物变化共同承担“品尝”的叙事。
