...
const frames: TastingFrame[] = [
  {
    id: '00', image: assetPath('/images/ramen-100.webp'), alt: '晨光木屋中，一碗完整豚骨拉面，筷子停在汤面上方', kind: 'wide', kicker: '未动筷 · 香气',
  ...
  {
    id: '01', image: assetPath('/images/ramen-01.webp'), alt: '筷子伸入豚骨汤中拨开面条', kind: 'action', kicker: '探入 · 触感',
  ...
  {
    id: '02', image: assetPath('/images/ramen-02.webp'), alt: '第一束细面被筷子提起，汤汁滴回碗中', kind: 'action', kicker: '提起 · 挂汤',
  ...
  {
    id: '03', image: assetPath('/images/ramen-03.webp'), alt: '挂着浓汤的细面向第一人称镜头靠近', kind: 'close', kicker: '第一口 · 汤先到',
  ...
  {
    id: '04', image: assetPath('/images/ramen-75.webp'), alt: '回到广角，豚骨拉面吃过第一口后剩余四分之三', kind: 'wide', kicker: '一口之后 · 面',
  ...
  {
    id: '05', image: assetPath('/images/ramen-05.webp'), alt: '筷子转向并夹住一半溏心蛋', kind: 'action', kicker: '转筷 · 蛋白',
  ...
  {
    id: '06', image: assetPath('/images/ramen-06.webp'), alt: '溏心蛋被提至碗上方，蛋黄和汤汁清晰可见', kind: 'close', kicker: '特写 · 蛋黄',
  ...
  {
    id: '07', image: assetPath('/images/ramen-07.webp'), alt: '溏心蛋向第一人称镜头靠近', kind: 'close', kicker: '入口 · 绵厚',
  ...
  {
    id: '08', image: assetPath('/images/ramen-50.webp'), alt: '回到广角，碗中拉面剩下一半', kind: 'wide', kicker: '半碗 · 余味',
  ...
  {
    id: '09', image: assetPath('/images/ramen-09.webp'), alt: '筷子伸入半碗拉面中夹住叉烧', kind: 'action', kicker: '夹取 · 叉烧',
  ...
  {
    id: '10', image: assetPath('/images/ramen-10.webp'), alt: '叉烧被提起，脂肪与肉纤维形成特写', kind: 'close', kicker: '特写 · 肉与脂',
  ...
  {
    id: '11', image: assetPath('/images/ramen-11.webp'), alt: '柔软叉烧向第一人称镜头靠近', kind: 'close', kicker: '入口 · 肉香',
  ...
  {
    id: '12', image: assetPath('/images/ramen-25.webp'), alt: '回到广角，碗中只剩四分之一拉面', kind: 'wide', kicker: '碗底 · 集中',
  ...
  {
    id: '13', image: assetPath('/images/ramen-13.webp'), alt: '最后一束挂着浓汤的细面向第一人称镜头靠近', kind: 'close', kicker: '最后一束 · 浓处',
  ...
  {
    id: '14', image: assetPath('/images/ramen-0.webp'), alt: '汤面已经吃完，空碗里只留汤痕，筷子放在碗沿', kind: 'wide', kicker: '碗空 · 身体记得',
    ...
    <main className="tasting-page">
      <div className="scroll-track" ref={trackRef} id="top" style={trackStyle}>
        <section className="tasting-stage" aria-labelledby="dish-title">
          ...
          <figure className="ramen-figure" aria-label={active.alt} ref={figureRef} style={figureStyle} data-active-frame={active.id} data-transition-mode={transitionMode}>
            {[0, 1, 2].map((slot) => (
              <img
